...
soatlar = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="0️⃣0️⃣", callback_data="00"),
            InlineKeyboardButton(text="0️⃣1️⃣", callback_data="01"),
            InlineKeyboardButton(text="0️⃣2️⃣", callback_data="02"),
            InlineKeyboardButton(text="0️⃣3️⃣", callback_data="03"),
        ],
        [
            InlineKeyboardButton(text="0️⃣4️⃣", callback_data="04"),
            InlineKeyboardButton(text="0️⃣5️⃣", callback_data="05"),
        ...
        [
            ...
            InlineKeyboardButton(text="1️⃣9️⃣", callback_data="19"),
        ],
        [
            InlineKeyboardButton(text="2️⃣0️⃣", callback_data="20"),
            InlineKeyboardButton(text="2️⃣1️⃣", callback_data="21"),
            InlineKeyboardButton(text="2️⃣2️⃣", callback_data="22"),
            InlineKeyboardButton(text="2️⃣3️⃣", callback_data="23"),
        ],
    ]
)
